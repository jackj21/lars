...
- Developed in 2004 by Standford affiliates Bradley Efron, Trevor Hastie, Iain Johnstone and Robert Tibshirani
...
- LARS is like a combination of forward stepwise regression and forward stagwise regression
...
-	Add that next predictor variable to the model, then increase their coeffients in the direction of the joint least-squares coefficeint until another predictor variable of similar correlation to their residual is found
